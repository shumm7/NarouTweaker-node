...
export namespace __nt_font_v1__ {
    /**
     * フォントセットリスト(v1)
     */
    export type FontFamilies = Array<FontFamily>
    ...
    export class FontFamily {
        ...
        constructor(f?: FontFamily|Object|null){
     ...
     * デフォルトのフォントセット
     */
    export const localFontFamily: FontFamilies = [
        {
            "name": "ゴシック体〔デフォルト〕",
    ...
    */
    export function noDuplicateName(fonts: FontFamilies, name: string, selected?: number): string{
        ...
        function checkSkinNameDuplicate(fonts: FontFamilies, name: string, selected?: number){
