...
export namespace __nt_skin_v1__ {
     ...
     * @param {__nt_text__.CSS_String} css - カスタムCSS
     */
    export class Skin{
        [key: string]: any
        ...
        show: boolean =  true
        style: Skin_Style = new Skin_Style
        css: __nt_text__.CSS_String = ""

        constructor(skin?: Skin|Record<string,any>){
            this.set(skin)
        }

        set(key?: Record<string,any>|Skin): void;
        ...
        set(key?: any, value?: any): void{
            if(key instanceof Skin){
                ...
                if("name" === key && typeof key==="string"){
                    ...
                    this.style = new Skin_Style(value)
                }
    ...
    class Skin_Style {
        novel: Skin_Style_Novel = new Skin_Style_Novel
        link: Skin_Style_Link = new Skin_Style_Link
        sublist: Skin_Style_Sublist = new Skin_Style_Sublist

        constructor(style?: Skin_Style|Object|null){
            if(style!==undefined && style!==null){
                if("novel" in style && typeof style.novel==="object"){
                    this.novel = new Skin_Style_Novel(style.novel)
                }
                if("link" in style && typeof style.link==="object"){
                    this.link = new Skin_Style_Link(style.link)
                }
                if("sublist" in style && typeof style.sublist==="string"){
                    this.sublist = new Skin_Style_Sublist(style.sublist)
                }
            }
        }
    }
    class Skin_Style_Novel{
        background: string = "#fff"
        background_second: string = "#dfdfdf"
        color: string = "#444"

        constructor(style?: Skin_Style_Novel|Object|null){
            if(style!==undefined && style!==null){
    ...
    class Skin_Style_Sublist{
        color: string = "#444"
        hover: string = "#9df"
        visited: string = "#73a6bf"

        constructor(style?: Skin_Style_Sublist|Object|null){
            if(style!==undefined && style!==null){
                if("color" in style && typeof style.color==="string"){
                    this.color = style.color
                }
     ...
     * @returns {string} - スキン名
    */
    export function generateNoDuplicateSkinName(skins: Skins, name: string, selected?: number): string{
        ...
        function checkSkinNameDuplicate(skins: Skins, name: string, selected?: number){
     ...
     * @returns {string} - スキン名
    */
    export function makeSkinCSS(skin: Skin, novelCustomStyle?: boolean): __nt_text__.CSS_String{
        const s = skin.style
        var rule: __nt_text__.CSS_String = ""
